...
<div class="card border-0 shadow-sm">
    ...
    <div class="card-body">
        <div class="row g-3">
            <div class="col-md-6"><strong>Mã hóa đơn:</strong> {{ $payment->invoice_code }}</div>
            ...
            <div class="col-md-6"><strong>Hạn thanh toán:</strong> {{ $payment->payment_due_date?->format('d/m/Y') }}</div>
