...
<div class="row g-3">
    ...
    <div class="col-md-4">
        ...
        <div class="input-group">
            <input type="text" name="tuition_fee_display" value="{{ intval(old('tuition_fee', $class->tuition_fee ?? 0)) }}" class="form-control currency-input @error('tuition_fee') is-invalid @enderror" placeholder="VD: 1.500.000" data-target="tuition_fee">
            <span class="input-group-text">đ</span>
            <input type="hidden" name="tuition_fee" value="{{ intval(old('tuition_fee', $class->tuition_fee ?? 0)) }}">
